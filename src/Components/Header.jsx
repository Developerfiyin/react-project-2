...
const Header = () => {
  return (
    <div className='w-full min-h-screen mb-4 flex items-center bg-cover bg-center overflow-hidden ' style={{backgroundImage: "url('src/assets/header_img.png')"}} id="header">
       <Navbar /> 
       <div className='mx-auto py-4 px-6 md:px-16 lg:px-32 text-white text-center'>
        ...
        <a href="#contact" className='py-3 px-8 border border-white rounded'><button>Contact Us </button></a>
        </div>
